def distanceToOriHighway(x1, y1):
    Origin = [x1, y1]
    IOList = []
    ##Interstate 5
    ...
    IOList.append(
        sqrt(((SeventyFivePortCharlotte[1] - Origin[1]) ** 2) + ((SeventyFivePortCharlotte[0] - Origin[0]) ** 2)))
    ...
    return minValueHighwayOrigin, highwayO


##Calculates distance between destination and the closest highway



def distanceToDestHighway(x2, y2):
    Destination = [x2, y2]
    IDList = []
    ##Interstate 5
    ...
    return minValueHighwayDestination, highwayD
